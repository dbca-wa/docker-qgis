...
RUN apt-get -y update; apt-get -y install gnupg software-properties-common; \
...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install qgis qgis-plugin-grass qgis-server gdal-bin git vim
